...
msg = "#{batman["alter_ego"]} is the secret identify of #{batman["f_name"]} #{batman["l_name"]}, an American #{batman["billionaire"] ? "billionaire, industrialist, and philanthropist" : "hobo"}."
